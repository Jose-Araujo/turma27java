...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("API - Blog Pessoal").description("Projeto API Spring - Blog Pessoal")
				.version("1.0.0").license("Apache License Version 2.0").licenseUrl("https://github.com/Jose-Araujo")
				.contact(contact()).build();
	}

	private static Contact contact() {
		return new Contact("José Araújo", "https://github.com/Jose-Araujo", "jose.vinicius450@gmail.com");
	}
